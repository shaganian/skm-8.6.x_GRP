...
const char vers[]   ="СКМ-"+vers_num+vers_type+vers_dev; // 31.05.2026 - Працює від зовнішнього живлення. Якщо його нема, то від малого акумулятора.
*/
 ...
 *   -  31день * 24часа = 744 записи для каждого месяца.
